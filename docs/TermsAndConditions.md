...
* The User is not allowed to remove User's distributed codes that was released under MIT license due to usage of this Library from the public without Licensor's permission.
